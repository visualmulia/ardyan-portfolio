...
1. **Memory:** Long-term and short-term state persistence.
2. **Planning:** The ability to break down a high-level goal (e.g., "Create a logistics database schema and deploy it to Vercel") into smaller, logical steps.
3. **Tool Access:** Permissions to write files, invoke shell commands, query databases, and fetch live web data.
4. **Self-Reflection:** Analyzing its own output, identifying errors, and self-correcting without human intervention.
